(function() {
    ...
    var Mixins = {
        ...
        join: function(channel) {
            if (channel.id) channel = channel.id; // join a model
            this.backend.socket.emit('join', channel);
        },
        leave: function(channel) {
            if (channel.id) channel = channel.id; // leave a model
            this.backend.socket.emit('leave', channel);
        },
    };
